    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading bg-light" style="width: 180px; margin: auto; padding: 0px;">
                <a href="<%= contextPath %>/views/admin/adminIndex.jsp"><img src="<%= contextPath %>/resources/image/logo.jpg" alt="" style="box-sizing: border-box; width: 100%; height: 100%;"></a>
            </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                <div style="text-align: right; margin-right: 15px;">
                    ...
                    <span><button type="button" class="btn btn-primary position-relative" style="margin-right: 15px;">
                        <a href="<%= contextPath %>/adminLogout.me" style="color:white; text-decoration: none;"><b>로그아웃</b></a>
                      </button></span>
                </div>
            </nav>
             <!-- Page content-->
