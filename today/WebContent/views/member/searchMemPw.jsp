...
<style>
	...
	<table class ="table" style="margin:0 auto;width:700px;">
		...
		<br>
		<tr>
			<td><input type="text" id="phone" name="phone" class="form-control" placeholder="휴대폰번호를 입력하세요"></td>
		</tr>
	</table>
	...
	<script>
		function searchPw(){
			...
			var url="<%=request.getContextPath()%>/searchPw.me"; //서블릿 요청
			var title="/searchPw";
