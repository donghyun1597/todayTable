	...
	<div class="m-4" id="paging">
        <nav>
            <div class="pagination">
            	<%if(currentPage != 1) { %>
                <button onclick="location.href='<%=contextPath%>/searchEvent.ev?cpage=<%= currentPage -1 %>&searchOption=<%= searchOption %>&searchText=<%= searchText %>';" class="page-link"> &lt; </button>
                <% } %>
                ...
                <%for(int p = startPage; p<=endPage; p++) { %>
                	...
                	<%}else{ %>
                	    <button onclick="location.href = '<%= contextPath%>/searchEvent.ev?cpage=<%=p%>&searchOption=<%= searchOption %>&searchText=<%= searchText %>';" class="page-link"><%=p %></button>
		        	<%} %>
		        <%} %>
